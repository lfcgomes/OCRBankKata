...
describe 'My behaviour' do
  ...
  it 'should be equal to 9' do
    r = Reader.new('acc_number.txt')
    r.interpret_number(' _ |_| _|').should eq(9)
  end
